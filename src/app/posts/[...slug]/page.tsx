      ...
      <article className='relative'>
        ...
        <ReactMarkdown
          ...
          components={{
            ...
            p: ({ ...props }) => <p {...props} className='mt-1 mb-5' />,
            blockquote: ({ ...props }) => (
              <blockquote
                {...props}
            ...
            input: ({ className, ...props }) => <input className={`${className} my-0 mr-1 mt-1 w-4 h-4`} {...props} />,
            a: ({ className, ...props }) => (
              <a className={`${className} text-slate font-light`} {...props} target='_blank' />
            ),
            del: ({ className, ...props }) => <del className={`${className} text-slate`} {...props} />,
